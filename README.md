...
1. **想用第三方模型**：官方自带模型种类有限，手头的 Claude、DeepSeek、GPT、Gemini 系列或本地 Ollama 模型没法直接在 Antigravity 中调用。
...
**Q: 我的 API Key 和代码安全吗？**
- 安全。Antigravity Studio 是 100% 纯本地运行的桌面客户端，没有外部云端服务器，所有配置保存在本地电脑，网络请求直接发送至对应模型服务商。
