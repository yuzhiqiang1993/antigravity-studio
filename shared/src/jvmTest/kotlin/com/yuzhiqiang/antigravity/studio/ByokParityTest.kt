...
class ByokParityTest {
    ...
    fun testOfficialGeminiUsageExtraction() {
        ...
        val root = jsonElement as kotlinx.serialization.json.JsonObject
        val effectiveRoot = root["response"] as kotlinx.serialization.json.JsonObject
        val usageObj = effectiveRoot["usageMetadata"] as kotlinx.serialization.json.JsonObject
