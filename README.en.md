...
- Yes. Antigravity Studio is 100% locally executed desktop application with no external cloud servers. All configurations stay on your machine, and requests are sent directly to your chosen providers.
...
- **License**: Antigravity Studio distributed packages are free for personal and team use under [MIT License](LICENSE).
- **Disclaimer**: Antigravity Studio is an independent desktop tool and is not affiliated with Google or the official Antigravity team. Please comply with the terms of service of your respective LLM providers.
